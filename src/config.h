...
TOUCH_LED_CYCLE(1, 1)
TOUCH_LED_CYCLE(7, 1)
CONDITIONAL(BUTTON(RUp), POSITION_ADJUST(10, -1))
CONDITIONAL(BUTTON(RDown), POSITION_ADJUST(10, 1))
CONDITIONAL(BUTTON(RUp), POSITION_ADJUST(8, 1))
CONDITIONAL(BUTTON(RDown), POSITION_ADJUST(8, -1))
CONDITIONAL(BUTTON(RUp), POSITION_ADJUST(2, -1))
CONDITIONAL(BUTTON(RDown), POSITION_ADJUST(2, 1))
